...
@section('title', 'Modifier le Livre - Libra')
    ...
    <div class="relative z-10 flex items-center gap-6">
        ...
        <div>
            <h1 class="text-4xl font-bold text-white mb-2 tracking-tight">
                <i class="fas fa-book mr-3 text-teal-400"></i>Modifier le Livre
            </h1>
            ...
            <p class="text-indigo-300 text-sm mt-1">
                <i class="fas fa-edit mr-2"></i>Modification de l'ouvrage : <span class="font-semibold">{{ $book->title }}</span>
            </p>
        </div>
    </div>
</div>
        ...
        <div class="px-8 py-8">
            <form method="POST" action="{{ route('books.update', $book->id) }}" class="space-y-6">
                ...
                <div class="group">
                    ...
                    <input type="text" name="isbn" value="{{ old('isbn', $book->isbn) }}" required maxlength="13" 
                ...
                <div class="group">
                    ...
                    <textarea name="description" rows="4" 
                              class="w-full pl-4 pr-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all text-gray-700 font-medium @error('description') border-rose-500 @enderror">{{ old('description', $book->description) }}</textarea>
                    @error('description')
                    <p class="text-xs text-rose-600 mt-1 ml-1"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                    @enderror
                </div>
